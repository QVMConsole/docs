...
export default function Agreement(): ReactNode {
  ...
  return (
    <Layout
      title="用户协议与内测须知"
      description="QVMConsole 用户协议与内测须知">
        ...
        <div className={styles.container}>
          ...
          <div className={styles.sections}>
            ...
            <section className={styles.section}>
              ...
              <div className={styles.sectionBody}>
                ...
                <p>
                  ...
                  本软件当前处于内测阶段，按"现状"提供，不附带任何明示或暗示的保证。开发者保留对本软件功能、界面及服务条款进行调整的权利。
                </p>
                ...
                <h3>3. 免责声明</h3>
                <p>
                  本软件为内测版本，开发者已尽合理努力保障软件质量，但不对软件的完整性、可靠性、安全性及适用性作任何保证。在中华人民共和国法律允许的最大范围内，开发者不对因使用或无法使用本软件而产生的任何直接或间接损失承担责任，包括但不限于数据丢失、服务中断、系统故障、业务中断、利润损失或任何其他损失。
                </p>
                <p>
            ...
            <section className={styles.section}>
              ...
              <div className={styles.sectionBody}>
                <h3>1. 内测阶段说明</h3>
                <p>
                  当前 QVMConsole 处于内测阶段，功能和接口可能随时调整，部分功能可能存在缺陷或运行不稳定的情况。内测版本不代表最终产品品质。
                </p>

                <h3>2. 安全风险重点说明</h3>
                <ul>
                  <li><strong>致命漏洞风险：</strong>内测版本可能存在尚未发现的安全漏洞，包括但不限于权限绕过、未授权访问、数据泄露、远程代码执行等严重安全缺陷</li>
                  ...
                  <li><strong>数据安全风险：</strong>内测阶段不保证数据的完整性和可恢复性，升级或卸载过程可能存在残留数据</li>
                </ul>

                <h3>3. 能力要求</h3>
                <p>
                  <strong>内测版本面向具备以下能力的技术人员：</strong>
                </p>
                <ul>
                ...
                <p>
                  如果您不具备上述能力，我们强烈建议您等待正式版本发布后再使用。
                </p>
                ...
                <h3>5. 数据备份</h3>
                <p>
                  强烈建议在安装和使用本软件前对宿主机及虚拟机中的重要数据进行完整备份。在内测阶段，任何操作（包括常规的创建、删除、迁移等）均可能导致数据不可恢复的丢失。
                </p>

                <h3>6. 反馈与奖励</h3>
                <p>
                  如在使用过程中发现 Bug 或安全问题，欢迎通过 QQ 群（654641487）或 GitHub Issues 进行反馈。有效的 Bug 反馈和安全漏洞报告将有助于产品的完善，内测期间积极反馈有效 Bug 并配合排查的用户将有机会获得后续 Pro 版订阅资格奖励。
                </p>
              </div>
            </section>
          </div>
          ...
          <div className={styles.warningBox}>
            ...
            <div className={styles.warningBoxBody}>
              <p>
                由于项目当前处于内测阶段，可能存在<strong>致命漏洞和 BUG</strong>，请务必确认您有相关能力去解决且<strong>强烈不建议没有能力的用户用于正式生产环境</strong>，避免存在致命 BUG 造成可用性问题。
              </p>
              <p>
                内测期间若您反馈有效的 Bug 和建议并配合排查一定数量后，则会奖励您后续 <strong>Pro 版订阅资格</strong>。
              </p>
            </div>
          </div>
          ...
          <div className={styles.agreeArea}>
            <label className={styles.checkboxLabel}>
              ...
              />
              <span>
                我已详细阅读并充分理解《用户协议》和《内测须知》的全部内容，已知悉内测版本可能存在的安全风险，确认自身具备相应的技术能力和经验，自愿承担使用本软件所带来的一切风险和责任
              </span>
            </label>
            <button

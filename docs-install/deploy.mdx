...
```bash
# 下载部署脚本（通用）
wget https://download.xiaozhuhouses.asia/%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE/QVMConsole/install.sh
```
...
<Tabs>
  <TabItem value="amd64" label="AMD64">
    ```bash
    wget https://download.xiaozhuhouses.asia/%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE/QVMConsole/kvm-console-linux-amd64.tar.gz
    ```
  </TabItem>
  <TabItem value="arm64" label="ARM64">
    ```bash
    wget https://download.xiaozhuhouses.asia/%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE/QVMConsole/kvm-console-linux-arm64.tar.gz
    ```
  </TabItem>
</Tabs>
...
支持 重置认证、修改端口等功能
```bash
wget https://download.xiaozhuhouses.asia/%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE/QVMConsole/qvmc-manage.sh
bash qvmc-manage.sh
```

...
```bash
wget -O install.sh https://download.xiaozhuhouses.asia/%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE/QVMConsole/Open/install.sh
```
...
<Tabs>
  <TabItem value="default-amd64" label="AMD64">
    ```bash
    wget -O kvm-console-linux-amd64.tar.gz https://download.xiaozhuhouses.asia/%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE/QVMConsole/Open/kvm-console-linux-amd64.tar.gz
    ```
  </TabItem>
  <TabItem value="default-arm64" label="ARM64">
    ```bash
    wget -O kvm-console-linux-arm64.tar.gz https://download.xiaozhuhouses.asia/%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE/QVMConsole/Open/kvm-console-linux-arm64.tar.gz
    ```
  </TabItem>
</Tabs>
...
```bash
wget -O install.sh https://github.com/QVMConsole/QVMConsole/blob/main/install.sh
```
...
```bash
wget -O install.sh https://download.xiaozhuhouses.asia/%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE/QVMConsole/Pro/install.sh
```
...
<Tabs>
  <TabItem value="amd64" label="AMD64">
    ```bash
    wget -O kvm-console-linux-amd64.tar.gz https://download.xiaozhuhouses.asia/%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE/QVMConsole/Pro/kvm-console-linux-amd64.tar.gz
    ```
  </TabItem>
  <TabItem value="arm64" label="ARM64">
    ```bash
    wget -O kvm-console-linux-arm64.tar.gz https://download.xiaozhuhouses.asia/%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE/QVMConsole/Pro/kvm-console-linux-arm64.tar.gz
    ```
  </TabItem>
</Tabs>
...
支持 重置认证、修改端口等功能
```bash
wget -O qvmc-manage.sh https://github.com/QVMConsole/QVMConsole/blob/main/qvmc-manage.sh
bash qvmc-manage.sh
```

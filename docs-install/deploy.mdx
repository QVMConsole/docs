...
```bash
wget -O install.sh https://download.xiaozhuhouses.asia/download/v1/links/SZz399anQVi_dBpyXdKEXuGedj1NgPDDCSauiFrZHDo
```
...
<Tabs>
  <TabItem value="default-amd64" label="AMD64">
    ```bash
    wget -O kvm-console-linux-amd64.tar.gz https://download.xiaozhuhouses.asia/download/v1/links/00N1_vsZ7VBNonrapxeptwricGrDs-8YMAafS3YYxEA
  </TabItem>
  <TabItem value="default-arm64" label="ARM64">
    ```bash
    wget -O kvm-console-linux-arm64.tar.gz https://download.xiaozhuhouses.asia/download/v1/links/NgGqqPK40ANc-iuM-ZcIvxSR7mmlVlb4iJ8N045SM6I
    ```
  </TabItem>
</Tabs>
...
```bash
wget -O install.sh https://download.xiaozhuhouses.asia/download/v1/links/9wvXtIXQMLi8WQ8Ie14YNDqUAFC4mHfS0J0HC-wGpnI
```
...
<Tabs>
  <TabItem value="amd64" label="AMD64">
    ```bash
    wget -O kvm-console-linux-amd64.tar.gz https://download.xiaozhuhouses.asia/download/v1/links/R7m2nvI9KSR6vfzWqUIEnwzM0a6hOOEo3MbuuMbVljk
    ```
  </TabItem>
  <TabItem value="arm64" label="ARM64">
    ```bash
    wget -O kvm-console-linux-arm64.tar.gz https://download.xiaozhuhouses.asia/download/v1/links/NzLMqDShNsiNn-O82pqpCMpAFd2VmxaQFl4Px0cMVqc
    ```
  </TabItem>
</Tabs>
...
```bash
wget -O qvmc-manage.sh https://download.xiaozhuhouses.asia/download/v1/links/qgRadNcpr403Qnr5ZNZ6vPnXaBwh3rrcU-t73tHbRoo
bash qvmc-manage.sh
```

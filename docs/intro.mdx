...
- [创建方式](/docs/tech/virtual-machine/creation-modes) - 四种虚拟机创建方式及其适用场景
...
- [存储配置](/docs/tech/virtual-machine/storage-config) - 磁盘、ISO镜像、存储池和IOPS限制
- [网络配置](/docs/tech/virtual-machine/network-config) - 网卡、VPC网络、安全组和流量管控
...
- [网络概览](/docs/tech/network/overview) - OVS 基础网络状态、网桥管理与端口监控
- [VPC 交换机](/docs/tech/network/vpc-switch) - 交换机创建、VLAN 隔离与流量配额管理
- [安全组策略](/docs/tech/network/security-group) - 安全组规则配置与 VPC 访问控制
...
- [公网IP管理](/docs/tech/public-ip/public-ip-management) - 公网IP的新增、绑定、解绑、迁移与规则管理
...
| 组件 | 技术 |
|------|------|
| 前端 | Vue.js 3 + Vite + Element Plus + Pinia + Axios |
| 后端 | Go (Gin) + go-libvirt (digitalocean/go-libvirt) + GORM |

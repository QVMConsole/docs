...
> **操作提示** 预览界面左下角会显示“滚轮缩放 · 拖拽移动 · ESC 关闭”提示。移动端窄屏下会自动隐藏该提示并放宽图片显示区域。
...
> **所有图片都会被放大吗？** 是的。所有通过 Markdown `![](url)` 语法插入的图片都会启用预览。如需排除特定图片，请使用 `<img data-no-zoom />`。

---

> 原文路径：/docs/install/site-guide/image-zoom（本文由 QVMConsole 文档站自动生成，供大模型阅读）
